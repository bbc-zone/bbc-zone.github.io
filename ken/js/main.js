;
(function () {
    const images = ['couple1.png', 'couple2.png', 'couple3.png'];
    ...
    // Gallery Slider
    $('.fh5co-gallery-slide').owlCarousel({
        items: 1,
        loop: true,
        margin: 20,
        autoplay: true,
...
$(document).ready(function () {
    ...
    if (guest) {
        const guestName = formatGuestName(decodeURIComponent(guest));

        $('#guestName').text(guestName);
        $('#greeting').text('Halo ' + guestName);
    }
